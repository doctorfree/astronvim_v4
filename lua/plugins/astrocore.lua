...
-- diagnostic mode on start (0 = off, 1 = no signs/virtual text,
--                           2 = no virtual text, 3 = on)
local diagnostics_mode = 3
...
return {
  ...
  opts = {
    ...
    features = {
      ...
      diagnostics_mode = diagnostics_mode, -- diagnostic mode on start (0 = off, 1 = no signs/virtual text, 2 = no virtual text, 3 = on)
    ...
    options = {
      ...
      g = {
        ...
        diagnostics_mode = diagnostics_mode, -- set the visibility of diagnostics in the UI (0=off, 1=only show in status line, 2=virtual text off, 3=all on)
