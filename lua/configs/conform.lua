...
if table_contains(formatters_linters, "php_cs_fixer") then
  table.insert(ft_formatters, { php = { "php_cs_fixer" } })
end
if table_contains(external_formatters, "flake8") then
  ...
  table.insert(ft_formatters, { python = { "isort", "black" } })
end
if table_contains(formatters_linters, "shellcheck") then
  ...
  table.insert(ft_formatters, { sh = { "shfmt" } })
  table.insert(ft_formatters, { zsh = { "shfmt" } })
  table.insert(ft_formatters, { bash = { "shfmt" } })
end
